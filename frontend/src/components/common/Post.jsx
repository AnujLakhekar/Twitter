...
const Post = ({ post }) => {
	...
	const {mutate:likePost, isPending:isLiking} = useMutation({
	  mutationFn: async () => {
	    try {
	      const res = await fetch(`https://twitterbackend-205b.onrender.com/api/post/like/${post._id}`, {
	       method: "POST",
	       headers: {
	         "Content-Type":"application/json"
	       },
	...
	const {mutate:Share, isPending:isSharing} = useMutation({
	  mutationFn: async () => {
	    try {
	      const res = await fetch(`https://twitterbackend-205b.onrender.com/api/post/share/${post._id}`, {
	       method: "POST",
	       headers: {
	         "Content-Type":"application/json"
	       },
